      ...
      <div className="flex flex-col items-center justify-center mt-16 w-full max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
          ...
          <div className="relative h-64 rounded-lg shadow-lg overflow-hidden group">
            <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: 'url("../src/assets/PremioSiweb.jpg")' }}></div>
          ...
          <div className="relative h-64 rounded-lg shadow-lg overflow-hidden group">
            <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: 'url("../src/assets/Celta.jpg")' }}></div>
            <div className="absolute inset-0 bg-gradient-to-t from-blue-900/70 to-blue-900/10"></div>
            <div className="relative h-full p-8 flex flex-col justify-end text-white z-10">
              <div className="flex items-center mb-4">
                <svg className="w-8 h-8 mr-3" fill="currentColor" viewBox="0 0 20 20">
